#!/usr/bin/env python3
"""
Build diagram v45 — AWS Step Functions Image Processing Architecture
...
# Step Functions container (nested inside AWS Cloud)
SF_X = 770
SF_Y = 10
SF_W = 440
SF_H = 920

# Sub-section Y — derived from SF_Y so sub-containers clear the SF header
